...
// MvtxPixelMasker class
//==============================================================================
void MvtxPixelMasker::load_from_CDB()
{
...
void MvtxPixelMasker::add_pixel(MvtxPixelDefs::pixelkey key)
{
...
void MvtxPixelMasker::remove_pixel(MvtxPixelDefs::pixelkey key)
{
...
void MvtxPixelMasker::clear()
{
    m_hot_pixel_map.clear();
    return;
}

bool MvtxPixelMasker::is_masked(MvtxRawHit* hit) const
{
